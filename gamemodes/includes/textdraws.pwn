...
{
	ServerTime = TextDrawCreate(308.000305, 5.822227, "01/01/2021_-_12:00~n~|AGTA-RP.NET|");
	TextDrawLetterSize(ServerTime, 0.334799, 1.719463);
	TextDrawAlignment(ServerTime, 2);
	TextDrawColor(ServerTime, -11632385);
	...
	// NG-RP Title
	MainMenuTxtdraw[4] = TextDrawCreate(263.000000, 10.000000, "AGTA-RP");
	...
	MainMenuTxtdraw[10] = TextDrawCreate(319.000000, 81.000000, "Day La Sever AGTA-RP, Neu Can Ho Tro Hay /Newb Neu Bi Bug Hay /Baocao.");
	...
	NoticeTxtdraw[1] = TextDrawCreate(317.000000, 174.000000, "AGTA-RP - Dang Tai Ban Doi Ti Nhe");
