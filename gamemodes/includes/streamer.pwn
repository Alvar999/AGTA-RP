...
{ 
	...
	//benh vien
	NewbieVehicles[1] = AddStaticVehicleEx(510, -2628.9407,	586.9419, 14.4531, 358.3073, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[2] = AddStaticVehicleEx(510, -2633.3877,	587.0138, 14.4531, 6.1407, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[3] = AddStaticVehicleEx(510, -2638.4402,	586.5046, 14.4531, 359.8740, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[4] = AddStaticVehicleEx(510, -2643.0256,	586.3787, 14.4531, 356.4273, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[5] = AddStaticVehicleEx(510, -2649.5291,	585.5888, 14.4531, 1.1274, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[6] = AddStaticVehicleEx(510, -2635.0718,	628.9378, 14.4531, 174.6922, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[7] = AddStaticVehicleEx(510, -2630.7441,	628.0425, 14.4531, 174.6922, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[8] = AddStaticVehicleEx(510, -2625.9775,	628.0739, 14.4531, 167.1722, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[9] = AddStaticVehicleEx(510, -2620.5762,	627.5749, 14.4531, 181.2724, 0, 1, VEHICLE_RESPAWN);
	NewbieVehicles[10] = AddStaticVehicleEx(510, -2616.0325, 628.7581, 14.4531, 185.9724, 0, 1, VEHICLE_RESPAWN);
...
public LoadStreamerDynamicPickups()
{
	...
	CreateDynamicPickup(1239, 23, -2764.5537,382.3419,6.3281, -1); //thibanglai
...
public LoadStreamerDynamic3DTextLabels()
{
	...
	CreateDynamic3DTextLabel("Ban Muon Thi Bang Lai \nSu dung /thibanglai de bat dau ngay ",COLOR_RED,-2764.5537,382.3419,6.3281+0.5,4.0);//thibanglai
	CreateDynamic3DTextLabel("Ban Muon Dang Ky CMND \nSu dung /dangkycmnd de dang ky",COLOR_RED,361.8317,173.6526,1008.3828+0.5,4.0);//cmnd
	...
	CreateDynamic3DTextLabel("Ngan Hang MB BANK) \nSu dung /guitien or /ruttien",COLOR_RED,1667.0760,-972.2538,683.6855+0.5,4.0);//bank
 	CreateDynamic3DTextLabel("Phong tap ban arena\n\nSu dung /thamgiaarena de vao phong",COLOR_YELLOW,-2663.4546,553.4243,14.6094+0.5,6.0);
	...
	/* Pickup TimViecLam */
	CreateDynamic3DTextLabel("JOB Trucker da duoc chuyen qua Las Venturas ( LV )", -1, -1560.963867, 127.491157, 3.554687+0.5,15.0);
	...
	CreateDynamic3DTextLabel("Nong Dan\nSu dung /xinviec hoac /muahatgiong de tuong tac",COLOR_WHITE,-1196.4404,-1070.0533,129.2188+0.5,15.0);// Nong Dan
	...
	CreateDynamic3DTextLabel("{FFFF00}Cong Viec Tai Xe Trucker{FFFFFF}\nSu dung {FFFF00}[ /xinviec ]{FFFFFF} de nhan cong viec nay",-1,1634.9628, 1038.6477, 10.8203+0.5,4.0);// Trucker Job (LV)
	...
	//cansa
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 1 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1434.88892, -2575.26123, 65.00000+0.5,10.0); // Cay Can Sa 1
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 2 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1418.22192, -2575.95215, 65.46000+0.5,10.0); // Cay Can Sa 2
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 3 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1472.02527, -2554.72168, 62.24000+0.5,10.0); // Cay Can Sa 3
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 4 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1481.97070, -2534.56812, 61.10000+0.5,10.0); // Cay Can Sa 4
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 5 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1495.00659, -2528.43262, 64.00000+0.5,10.0); // Cay Can Sa 5
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 6 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1488.25830, -2506.89209, 61.36000+0.5,10.0); // Cay Can Sa 6
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 7 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1502.99182, -2492.52344, 60.68000+0.5,10.0); // Cay Can Sa 7
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 8 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1485.98547, -2463.24414, 42.00000+0.5,10.0); // Cay Can Sa 8
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 9 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1467.54626, -2468.44385, 39.88000+0.5,10.0); // Cay Can Sa 9
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 10 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1450.17798, -2467.88330, 41.00000+0.5,10.0); // Cay Can Sa 10
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 11 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1435.40710, -2470.93774, 42.00000+0.5,10.0); // Cay Can Sa 11
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 12 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1416.02405, -2478.10913, 43.08000+0.5,10.0); // Cay Can Sa 12
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 13 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1399.28589, -2486.35718, 43.00000+0.5,10.0); // Cay Can Sa 13
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 14 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1372.79822, -2499.33374, 40.44000+0.5,10.0); // Cay Can Sa 14
	CreateDynamic3DTextLabel("{A1F700}Cay Can Sa {00FFE5}[ ID: 15 ]\n{A1F700}Su dung: /haicansa",-1 ,	-1318.37317, -2536.83057, 31.48000+0.5,10.0); // Cay Can Sa 15

	CreateDynamic3DTextLabel("Che bien can sa\nSu dung: H or /chebiencansa",COLOR_YELLOW,-395.7523, -1435.4697, 25.7266+0.5,30.0);

	CreateDynamic3DTextLabel("RUA TIEN BAN\nSu dung: H or /ruatienban",COLOR_YELLOW,2846.5195, 973.0493, 10.7500+0.5,30.0);
...
//actor
    ...
    Actor[1] = CreateActor(8,1634.9628, 1038.6477, 10.8203, 270.8764);// NPC Xin viec Trucker
	...
	Actor[14] = CreateActor(155, -1674.3713, -8.4116, 3.5547, 315.4044); //trucker
    ApplyActorAnimation(Actor[14], "BD_FIRE", "wash_up", 4.0, 1, 0, 0, 0, 0);
	...
	//hq-f11
	CreateDynamicObject(19869, -2477.15, 89.78, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2482.34, 89.76, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2487.55, 89.76, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2492.72, 89.72, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2497.97, 89.75, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2503.17, 89.77, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2506.04, 92.33, 35.00,   0.00, 0.00, 98.00);
	CreateDynamicObject(19869, -2471.89, 89.78, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2466.68, 89.74, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2461.43, 89.74, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2456.23, 89.74, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2506.79, 97.54, 35.00,   0.00, 0.00, 98.00);
	CreateDynamicObject(19869, -2507.62, 102.66, 35.00,   0.00, 0.00, 100.00);
	CreateDynamicObject(19869, -2508.21, 105.97, 35.00,   0.00, 0.00, 100.00);
	CreateDynamicObject(19869, -2506.36, 108.73, 35.00,   0.00, 0.00, -179.00);
	CreateDynamicObject(3749, -2446.68, 99.53, 40.00,   0.00, 0.00, -90.00);
	CreateDynamicObject(19869, -2451.36, 89.79, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(3528, -2442.78, 99.19, 40.90,   0.00, 0.00, 0.00);
	CreateDynamicObject(3471, -2443.56, 105.96, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(3471, -2443.61, 93.15, 35.00,   0.00, 0.00, 0.00);
	CreateDynamicObject(9833, -2501.28, 127.61, 25.80,   0.00, 0.00, 0.00);
	CreateDynamicObject(19869, -2506.11, 113.76, 25.00,   0.00, 0.00, -177.00);
	CreateDynamicObject(19869, -2508.73, 116.28, 25.00,   0.00, 0.00, -91.00);
	CreateDynamicObject(19869, -2508.73, 121.50, 25.00,   0.00, 0.00, -89.00);
	CreateDynamicObject(19869, -2508.72, 126.73, 25.00,   0.00, 0.00, -91.00);
	CreateDynamicObject(19869, -2508.59, 131.91, 25.00,   0.00, 0.00, -91.00);
	CreateDynamicObject(19869, -2508.61, 137.14, 25.00,   0.00, 0.00, -89.00);
	CreateDynamicObject(19869, -2508.66, 141.76, 25.00,   0.00, 0.00, -89.00);
	CreateDynamicObject(19869, -2503.77, 111.18, 24.80,   0.00, 0.00, -93.00);
	CreateDynamicObject(19869, -2503.81, 111.25, 27.30,   0.00, 0.00, -93.00);
	CreateDynamicObject(19869, -2506.22, 113.67, 27.30,   0.00, 0.00, 2.00);
	CreateDynamicObject(19869, -2508.81, 116.18, 27.30,   0.00, 0.00, 88.00);
	CreateDynamicObject(19869, -2508.75, 121.35, 27.30,   0.00, 0.00, 90.00);
	CreateDynamicObject(19869, -2508.83, 126.58, 27.30,   0.00, 0.00, 90.00);
	CreateDynamicObject(19869, -2508.69, 131.90, 27.30,   0.00, 0.00, 90.00);
	CreateDynamicObject(19869, -2508.65, 137.13, 27.30,   0.00, 0.00, 90.00);
	CreateDynamicObject(19869, -2508.69, 141.64, 27.30,   0.00, 0.00, 90.00);
	//maychebiencansa
	CreateDynamicObject(934, -395.50970, -1433.67603, 25.99890,   0.00000, 0.00000, 90.00000);

	//Cay Can Sa
	CreateDynamicObject(19473, -1434.88892, -2575.26123, 65.00000,   0.00000, 0.00000, 267.61829); 	// Cay Can Sa	1
	CreateDynamicObject(19473, -1418.22192, -2575.95215, 65.46000,   0.00000, 0.00000, 267.61829);	// Cay Can Sa	2
	CreateDynamicObject(19473, -1472.02527, -2554.72168, 62.24000,   0.00000, 0.00000, 4.12590);	// Cay Can Sa	3
	CreateDynamicObject(19473, -1481.97070, -2534.56812, 61.10000,   0.00000, 0.00000, 25.95500);	// Cay Can Sa	4
	CreateDynamicObject(19473, -1495.00659, -2528.43262, 64.00000,   0.00000, 0.00000, 64.78780);	// Cay Can Sa	5
	CreateDynamicObject(19473, -1488.25830, -2506.89209, 61.36000,   0.00000, 0.00000, 322.07611);	// Cay Can Sa	6
	CreateDynamicObject(19473, -1502.99182, -2492.52344, 60.68000,   0.00000, 0.00000, 46.40540);	// Cay Can Sa	7
	CreateDynamicObject(19473, -1485.98547, -2463.24414, 42.00000,   0.00000, 0.00000, 327.36130);	// Cay Can Sa	8
	CreateDynamicObject(19473, -1467.54626, -2468.44385, 39.88000,   0.00000, 0.00000, 229.93410);	// Cay Can Sa	9
	CreateDynamicObject(19473, -1450.17798, -2467.88330, 41.00000,   0.00000, 0.00000, 250.84390);	// Cay Can Sa	10
	CreateDynamicObject(19473, -1435.40710, -2470.93774, 42.00000,   0.00000, 0.00000, 242.80161);	// Cay Can Sa	11
	CreateDynamicObject(19473, -1416.02405, -2478.10913, 43.08000,   0.00000, 0.00000, 255.89900);	// Cay Can Sa	12
	CreateDynamicObject(19473, -1399.28589, -2486.35718, 43.00000,   0.00000, 0.00000, 243.49091);	// Cay Can Sa	13
	CreateDynamicObject(19473, -1372.79822, -2499.33374, 40.44000,   0.00000, 0.00000, 243.26109);	// Cay Can Sa	14
	CreateDynamicObject(19473, -1318.37317, -2536.83057, 31.48000,   0.00000, 0.00000, 1.68010);	// Cay Can Sa	15
	...
	// Prison
	CreateDynamicObject(3330, 54.47193, 1483.71729, 33.68685,   0.00000, 0.00000, 38.59999, .streamdistance = 700);
	CreateDynamicObject(3330, 35.31974, 1473.86169, 33.68685,   0.00000, 0.00000, 15.49999, .streamdistance = 700);
	CreateDynamicObject(3330, 13.11418, 1469.71704, 33.68685,   0.00000, 0.00000, 4.79999, .streamdistance = 700);
	CreateDynamicObject(3330, -9.52279, 1470.14441, 33.68685,   0.00000, 0.00000, -5.50001, .streamdistance = 700);
	CreateDynamicObject(3330, -31.45572, 1475.20874, 33.68685,   0.00000, 0.00000, -20.50001, .streamdistance = 700);
	CreateDynamicObject(3330, -50.51438, 1486.97253, 33.68685,   0.00000, 0.00000, -43.00001, .streamdistance = 700);
	CreateDynamicObject(3330, -65.74503, 1504.10376, 33.68685,   0.00000, 0.00000, -54.30002, .streamdistance = 700);
	CreateDynamicObject(3330, -69.68480, 1524.72888, 33.68685,   -2.50000, 0.00000, -102.20002, .streamdistance = 700);
	CreateDynamicObject(3330, -57.52161, 1541.86780, 33.58528,   0.00000, 0.00000, 31.20002, .streamdistance = 700);
	CreateDynamicObject(3330, -41.23281, 1556.74683, 33.58528,   0.00000, 0.00000, 53.60007, .streamdistance = 700);
	CreateDynamicObject(3330, -28.01740, 1574.67273, 33.58528,   0.00000, 0.00000, 53.60007, .streamdistance = 700);
	CreateDynamicObject(3330, -9.01008, 1582.91418, 33.58528,   0.00000, 0.00000, -2.69992, .streamdistance = 700);
	CreateDynamicObject(3330, 13.93422, 1581.26392, 33.58528,   0.00000, 0.00000, -7.19992, .streamdistance = 700);
	CreateDynamicObject(3330, 36.15755, 1578.45703, 33.58528,   0.00000, 0.00000, -7.19992, .streamdistance = 700);
	CreateDynamicObject(3330, 58.37104, 1575.65112, 33.58528,   0.00000, 0.00000, -7.19992, .streamdistance = 700);
	CreateDynamicObject(3330, 79.59076, 1568.53455, 33.58528,   0.00000, 0.00000, -32.39993, .streamdistance = 700);
	CreateDynamicObject(3330, 96.80768, 1553.65637, 33.58528,   0.00000, 0.00000, -50.09992, .streamdistance = 700);
	CreateDynamicObject(3330, 71.68880, 1497.46033, 33.68685,   0.00000, 0.00000, 38.59999, .streamdistance = 700);
	CreateDynamicObject(3330, 89.35898, 1511.56787, 33.68685,   0.00000, 0.00000, 38.59999, .streamdistance = 700);
	CreateDynamicObject(4079, -37.31917, 1521.35193, 24.49001,   0.00000, 0.00000, 34.90001, .streamdistance = 700);
	CreateDynamicObject(13636, 27.48949, 1562.10742, 13.54881,   0.00000, -0.70000, 87.40003, .streamdistance = 700);
	CreateDynamicObject(3749, 104.07719, 1535.03687, 20.34215,   0.00000, -7.00000, 92.59999, .streamdistance = 700);
	CreateDynamicObject(3330, 98.25257, 1518.66565, 27.75685,   0.00000, 0.00000, 38.59999, .streamdistance = 700);
	CreateDynamicObject(3267, 104.37673, 1529.73706, 24.66696,   0.00000, 0.00000, -82.00002, .streamdistance = 700);
	CreateDynamicObject(3267, 104.28337, 1532.84326, 25.10697,   0.00000, 0.00000, -82.00002, .streamdistance = 700);
	CreateDynamicObject(3267, 104.16338, 1535.42053, 25.45698,   0.00000, 0.00000, -82.00002, .streamdistance = 700);
	CreateDynamicObject(3267, 104.20795, 1538.19238, 25.81698,   0.00000, 0.00000, -82.00002, .streamdistance = 700);
	CreateDynamicObject(3267, 104.27245, 1541.03821, 26.16699,   0.00000, 0.00000, -82.00002, .streamdistance = 700);
	CreateDynamicObject(987, 57.06237, 1565.15137, 11.71880,   0.00000, 0.00000, 133.80003, .streamdistance = 700);
	CreateDynamicObject(987, 65.33352, 1556.52563, 11.71880,   0.00000, 0.00000, 133.80003, .streamdistance = 700);
	CreateDynamicObject(987, 68.36596, 1544.96790, 11.71880,   0.00000, 0.00000, 104.70002, .streamdistance = 700);
	CreateDynamicObject(987, 69.77377, 1523.81555, 11.71880,   0.00000, 0.00000, 96.89999, .streamdistance = 700);
	CreateDynamicObject(987, 72.50487, 1500.08105, 11.71880,   0.00000, 0.00000, 96.89999, .streamdistance = 700);
	CreateDynamicObject(987, 71.21416, 1511.91248, 11.71880,   0.00000, 0.00000, 96.89999, .streamdistance = 700);
	CreateDynamicObject(3864, 56.55226, 1493.67261, 17.84140,   0.00000, 0.00000, -35.30001, .streamdistance = 700);
	CreateDynamicObject(3864, 43.73125, 1484.15002, 17.84140,   0.00000, 0.00000, -53.39999, .streamdistance = 700);
	CreateDynamicObject(3864, 24.72813, 1477.95703, 17.84140,   0.00000, 0.00000, -79.99999, .streamdistance = 700);
	CreateDynamicObject(3864, 3.30590, 1475.03699, 17.63140,   0.00000, 0.00000, -91.70003, .streamdistance = 700);
	CreateDynamicObject(3864, -11.78195, 1475.00000, 17.63140,   0.00000, 0.00000, -122.90002, .streamdistance = 700);
	CreateDynamicObject(3268, -18.24145, 1568.64063, 11.75000,   0.00000, 0.00000, 132.99991, .streamdistance = 700);
	CreateDynamicObject(3819, 42.27077, 1546.00012, 12.71000,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(3819, 42.27077, 1537.05017, 12.71000,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(3819, 42.27077, 1528.09009, 12.71000,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(2567, -17.82703, 1502.44983, 13.56999,   0.00000, 0.00000, -100.50005, .streamdistance = 700);
	CreateDynamicObject(709, 8.50193, 1572.87439, 9.92217,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(8078, -23.06620, 1481.53943, 15.32000,   0.00000, 0.00000, -84.40006, .streamdistance = 700);
	CreateDynamicObject(987, -31.88219, 1488.54297, 16.41852,   0.00000, 0.00000, 34.30001, .streamdistance = 700);
	CreateDynamicObject(3279, 61.72681, 1549.15210, 11.47127,   0.00000, 0.00000, -178.70021, .streamdistance = 700);
	CreateDynamicObject(3279, 62.17251, 1529.50671, 11.47127,   0.00000, 0.00000, -178.70021, .streamdistance = 700);
	CreateDynamicObject(987, 46.46651, 1574.50525, 11.91469,   0.00000, 0.00000, -94.69996, .streamdistance = 700);
	CreateDynamicObject(987, 45.48984, 1562.62646, 11.91469,   0.00000, 0.00000, -94.69996, .streamdistance = 700);
	CreateDynamicObject(987, 44.50576, 1550.65759, 11.91469,   0.00000, 0.00000, -86.69997, .streamdistance = 700);
	CreateDynamicObject(987, 45.89306, 1526.59717, 11.91469,   0.00000, 0.00000, -86.69997, .streamdistance = 700);
	CreateDynamicObject(987, 45.19939, 1538.62769, 11.91469,   0.00000, 0.00000, -86.69997, .streamdistance = 700);
	CreateDynamicObject(987, 46.58727, 1514.55786, 11.91469,   0.00000, 0.00000, -43.99998, .streamdistance = 700);
	CreateDynamicObject(3749, 63.26365, 1504.73474, 17.03780,   0.00000, 0.00000, -7.20000, .streamdistance = 700);
	CreateDynamicObject(987, -29.29652, 1490.30542, 16.41852,   0.00000, 0.00000, 34.30001, .streamdistance = 700);
	CreateDynamicObject(987, -19.62929, 1496.89697, 16.40889,   0.00000, 0.00000, 80.99994, .streamdistance = 700);
	CreateDynamicObject(987, -17.76301, 1508.68140, 16.40889,   0.00000, 0.00000, 80.99994, .streamdistance = 700);
	CreateDynamicObject(987, -16.04424, 1520.03430, 15.48888,   0.00000, 0.00000, 136.60007, .streamdistance = 700);
	CreateDynamicObject(9241, -39.36154, 1522.46802, 21.17321,   0.00000, 0.00000, -98.59997, .streamdistance = 700);
	CreateDynamicObject(8168, 17.38603, 1574.17603, 13.51602,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 20.41648, 1540.27905, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 15.70648, 1544.13928, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 26.80650, 1541.27942, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 24.41649, 1537.34949, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 14.80649, 1537.34949, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 10.23649, 1541.93945, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
	CreateDynamicObject(868, 21.86650, 1545.20984, 11.76999,   0.00000, 0.00000, 0.00000, .streamdistance = 700);
